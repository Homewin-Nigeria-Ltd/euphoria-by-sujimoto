...
const BookReservationForm = () => {
  return (
    <div className='w-screen h-auto bg-black flex justify-center items-center p-5 md:p-20'>
      <div className='w-full h-full p-5 md:p-20 flex items-center border-[.8px] border-[#A85B5B] bg-book-reservation backdrop-blur-[9px] bg-[#777777] bg-opacity-[.06]'>
        <div className='flex flex-col space-y-10 md:space-y-20 w-full'>
          <div className='flex flex-col space-y-2'>
            <p className='bg-book-reservation-gradient text-transparent bg-clip-text font-federo text-[22px] md:text-[30px] leading-normal tracking-[6px] uppercase'>
              Book Reservation
            </p>
            <p className='font-metrophobic text-white text-[14px] md:text-[16px] leading-normal'>
          ...
          <form>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-end'>
              ...
              <div className='flex flex-col space-y-5 md:space-y-8'>
                <label
                  htmlFor='fullname'
                  className='font-metrophobic text-white text-[14px] md:text-[20px] leading-normal'
                >
                  Full Name
                </label>
                <input
