...
const LocationSection = () => {
  ...
  return (
    <div className='w-screen h-[991px] flex justify-center items-center p-20 relative'>
      <div className='flex flex-col space-y-5 px-8 py-12 bg-location-top-box-gradient absolute top-0 left-10 z-10 rounded-bl-[10px] border border-white border-opacity-[.40]'>
        <p className='font-bruno-ace text-white text-[16px] leading-normal tracking-[7.12px] uppercase'>
          location
        </p>
      ...
      <Image
        ...
        alt='banner'
        className='absolute inset-0 w-screen h-[991px] object-cover'
        priority
      />
      <div className='absolute inset-0 bg-location-section-gradient'></div>
      {/* inner content */}
      <div className='flex p-10 justify-center items-center bg-white bg-opacity-[0.08] backdrop-blur-[13.445393562316895px] w-[80%] mt-[15rem]'>
        <div className='flex flex-col space-y-10 justify-center items-center'>
          <p className='font-bruno-ace-sc text-white text-[14.391px] leading-[35.854px] tracking-[6.404px] uppercase'>
          ...
          {/* feature section */}
          <div className='grid grid-cols-6 gap-[30px] px-20 py-5 rounded-[2px]'>
