        ...
        <div className="flex flex-col space-y-10 md:space-y-20 justify-center items-center mt-[8rem]">
          ...
          <div className="flex flex-col space-y-2 justify-center items-center">
            <div className="flex flex-col justify-center items-center">
              <h1
                className="font-cormorant-unicase font-bold text-white text-[65px] md:text-[140px] leading-normal uppercase animate-fade-in"
                data-scroll
                data-scroll-speed="2"
              >
                Euphoria
          ...
          <div className="flex flex-col space-y-10 justify-center items-center cursor-pointer absolute bottom-[6.5rem] md:bottom-[2.5rem]">
            ...
            <Marquee
              ...
              gradient={false}
              pauseOnHover={true}
              className="absolute -bottom-[1rem] md:bottom-[1rem] left-0"
            >
