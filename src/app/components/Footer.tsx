...
const Footer = () => {
  ...
  return (
    <div className='w-screen h-[928px] justify-center items-center bg-black bg-opacity-[60%] relative'>
      ...
      />
      <div className='w-full h-full px-20 py-10 flex flex-col relative z-10 justify-end space-y-20'>
        {/* <FooterSwiper /> */}
        ...
        <div className='w-full flex flex-col space-y-10 justify-center items-center'>
          <p className='font-bruno-ace text-white text-[32px] leading-[]60px] tracking-[14.24px] uppercase'>
            Contact us
          </p>
          <div className='grid grid-cols-3 w-full justify-center items-center'>
            {socials.map((social, index) => (
              <a
                key={index}
                href={social.link}
                className='font-bruno-ace text-white text-[32px] leading-[]60px] tracking-[14.24px] uppercase flex justify-center items-center border border-r-white'
              >
                {social.name}
              </a>
            ))}
          ...
          <div className='grid grid-cols-3 w-full'>
            ...
            <p className='font-cormorant-unicase font-bold text-white text-[20px] leading-normal capitalize w-full flex justify-end items-center'>
